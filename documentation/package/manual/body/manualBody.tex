...
After the Inspector moves, if he moves at all, agents in the other Angola regions collect diamonds according to the both-pay rule described on page \pageref{sec:aboutBids}.  Diamonds in regions where no player bids or both players tie simply remain in their regions, accumulating for the next round.
