...
If both players have Diamond Trust Game Cards, they can connect to each other directly with no transmission time, and both players will experience the game's music.  After touching ``Two Player'' from the title screen, one player should touch ``Host Multi-Card Play'' while the other player touches ``Join Game.''
